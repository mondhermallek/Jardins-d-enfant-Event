...
class MobileController extends Controller
{
    ...
    /**
     * @Route("/loginM/{username}/{password}", name="login")
    ...
    public function loginAction(Request $request, $username, $password)
    {
        ...
        $formatted = $serializer->normalize($user, null, [ObjectNormalizer::ATTRIBUTES => ['id', 'username', 'email', 'roles','sexe', 'adresse', 'name', 'firstName']]);
