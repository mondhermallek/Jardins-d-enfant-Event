...
class Evenement extends \EvenementBundle\Entity\Evenement implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'EvenementBundle\\Entity\\Evenement' . "\0" . 'id', '' . "\0" . 'EvenementBundle\\Entity\\Evenement' . "\0" . 'nomE', '' . "\0" . 'EvenementBundle\\Entity\\Evenement' . "\0" . 'type', '' . "\0" . 'EvenementBundle\\Entity\\Evenement' . "\0" . 'dateDebut', '' . "\0" . 'EvenementBundle\\Entity\\Evenement' . "\0" . 'dateFin', '' . "\0" . 'EvenementBundle\\Entity\\Evenement' . "\0" . 'description', '' . "\0" . 'EvenementBundle\\Entity\\Evenement' . "\0" . 'nbrParticipants', '' . "\0" . 'EvenementBundle\\Entity\\Evenement' . "\0" . 'nbrPlaces', '' . "\0" . 'EvenementBundle\\Entity\\Evenement' . "\0" . 'participant'];
        }
    ...
    public function setNbrPlaces($nbrPlaces)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNbrPlaces', [$nbrPlaces]);

        return parent::setNbrPlaces($nbrPlaces);
    }
    ...
    public function setNbrParticipants($nbrParticipants)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNbrParticipants', [$nbrParticipants]);

        return parent::setNbrParticipants($nbrParticipants);
    }
    ...
    public function AddNbrParticipants()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'AddNbrParticipants', []);

        return parent::AddNbrParticipants();
    }
    ...
    public function RemoveNbrParticipants()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'RemoveNbrParticipants', []);

        return parent::RemoveNbrParticipants();
    }
