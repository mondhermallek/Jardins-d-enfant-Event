...
class Evenement extends \EvenementBundle\Entity\Evenement implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'EvenementBundle\\Entity\\Evenement' . "\0" . 'id', '' . "\0" . 'EvenementBundle\\Entity\\Evenement' . "\0" . 'nom', '' . "\0" . 'EvenementBundle\\Entity\\Evenement' . "\0" . 'type', '' . "\0" . 'EvenementBundle\\Entity\\Evenement' . "\0" . 'dateDebut', '' . "\0" . 'EvenementBundle\\Entity\\Evenement' . "\0" . 'dateFin', '' . "\0" . 'EvenementBundle\\Entity\\Evenement' . "\0" . 'description', '' . "\0" . 'EvenementBundle\\Entity\\Evenement' . "\0" . 'nbrParticipants'];
        }
